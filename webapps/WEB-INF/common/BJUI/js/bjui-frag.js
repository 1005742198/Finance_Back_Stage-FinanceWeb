...
//    })
    ...
    BJUI.setRegional('ajaxnosend', 'Communication with the server is interrupted, please check the URL link or server status!')//modified by hj
    ...
    window.FRAG = {
        dialog: '<div class="bjui-dialog bjui-dialog-container" style="top:150px; left:300px;">' +
                ...
                '        <a class="close dia-close" href="#close" title="#close#"><i class="fa fa-times-circle"></i></a>' +
