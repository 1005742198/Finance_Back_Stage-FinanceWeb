...
+function ($) {
    ...
    var BJUI = {
        ...
        eventType: {
            ...
            afterDragDialog: 'bjui.afterDragDialog',// modified by hj 
        ...
        ajaxTimeout: 30000,
        statusCode: {ok:200, error:300, timeout:301, info:601, warn:602},//modified by hj 
...
//            mask   : true
        ...
        loadLogin: function() {
            ...
            //modified by hj
            $(document).alertmsg('warn', login.msg,{okName:login.okName,title:login.title,okCall:login.okCall})
