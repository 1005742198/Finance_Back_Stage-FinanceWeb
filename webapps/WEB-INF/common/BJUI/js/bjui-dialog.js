 ...
 * -- Modified from dwz.dialog.js, dwz.dialogDrag.js, dwz.resize.js
    ...
    Dialog.prototype.open = function() {
        ...
        if ($dialog) { //if the dialog id already exists
            ...
            $dialog.on('click', function(e) {
	            ...
	            //modified by hj
//             	$dialog.trigger(BJUI.eventType.resizeGrid)
    ...
    Dialog.prototype.drag = function(e, $dialog) {
        ...
        $dialog.basedrag({
            ...
            stop     : function() {
                ...
                //modified by hj
                $dialog.trigger(BJUI.eventType.afterDragDialog);
            },
            event    : e,
            nounbind : true
        })
