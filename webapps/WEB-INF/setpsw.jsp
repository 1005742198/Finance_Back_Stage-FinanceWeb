			...
			<div class="login_container hj_wrap">
				...
				<div class="fp-box">
					...
					<div class="con show" id="form-cont1">
						<div class="form-cont">
							<form id="retrievePsw_valid" action="" method="post" data-toggle="validate">
							<input type="hidden" name="k" id="k" value="">
								<div class="form-group">
									<label for="hj_captcha" class="control-label x100">手机号：</label> 
									<input type="text" data-rule="required;mobile" data-msg-required="请填写手机号" data-rule-mobile="[/^1[3-9]\d{9}$/, '手机号格式不正确']" name="phone" id="phone" value="" class="form-control input-nm">
								</div>
