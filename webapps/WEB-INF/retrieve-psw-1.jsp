						...
						<div class="form-cont">
							<form id="retrievePsw_valid" action="<%=request.getContextPath()%>/retrievePsw-valid.do" method="post" data-toggle="validate">
								...
								<div class="form-group">
									...
									<input type="text" data-rule="required;mobile" data-msg-required="请填写手机号" data-rule-mobile="[/^1[3-9]\d{9}$/, '手机号格式不正确']" name="phone" id="phone" value="" class="form-control input-nm" autocomplete="off">
								</div>
								<div class="form-group">
