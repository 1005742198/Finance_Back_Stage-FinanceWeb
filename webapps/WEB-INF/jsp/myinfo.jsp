...
<div class="bjui-pageContent">
	<form id="mainForm" action="<%=request.getContextPath() %>/updateMyinfo.do" data-toggle="validate" data-confirm-msg="" data-callback="updatecallback" data-loadingmask="false">
