 ...
 <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tbody>
    		...
    		<tr>
    			...
    			<td>${obj.paymentNo}</td>
    			<td>
    				<fmt:formatNumber value="${obj.payTxAmount}"  pattern="0.00" maxFractionDigits="2"/>
    			</td>
    			<td>
    				<fmt:formatNumber value="${obj.payUserAmount}"  pattern="0.00" maxFractionDigits="2"/>
    			</td>
    			<td>
    				<fmt:formatNumber value="${obj.payChannelAmount}"  pattern="0.00" maxFractionDigits="2"/>
    			</td>
    			<td>
    				<fmt:formatNumber value="${obj.bizPayMoney}"  pattern="0.00" maxFractionDigits="2"/>
    			</td>
    			<td>
