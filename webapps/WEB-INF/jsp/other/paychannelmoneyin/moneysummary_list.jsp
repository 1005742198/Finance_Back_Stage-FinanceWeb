    ...
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<c:forEach var="obj" items="${list }">
	    	<tr>
	    		...
	    		<td><fmt:formatNumber value="${obj.inMoney }" pattern="0.00"/></td>
	    		...
	    		<td>
	    			<c:if test="${powerlist.contains('/other/paychannelmoneyin/paychannel_settle.do') && (obj.settleStatus == 0 || obj.settleStatus == 3)}">
		  				...
		  				class="btn btn-blue" data-toggle="doajax" data-callback="afterSettle" data-confirm-msg="确定发起渠道入金结算吗？">渠道入金结算</a>
		  			</c:if>
