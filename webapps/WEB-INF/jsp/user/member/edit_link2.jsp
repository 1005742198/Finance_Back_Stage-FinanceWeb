                ...
                <tbody>
                	<tr>
                        <td colspan="2">
                            ...
                            <input maxlength="100" type="text" name="deparmentName" value="<c:out value='${userExt.deparmentName }'/>"  size="40" data-rule="required;" data-ok="" maxlength="33">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td>
                            ...
                            <input maxlength="40" type="text" name="linkPhone" value="<c:out value='${userExt.linkPhone }'/>"  size="20" data-rule="required;mobile;" data-ok="">
                        </td>
                        <td>
