...
<div class="bjui-pageContent">
        <div style="margin:0px auto 0; width:100%;">
                ...
                <ul class="nav nav-tabs" role="tablist">
			        ...
			        <li><a href="<%=request.getContextPath()%>/user/view/files.do?id=${userId}" role="tab" data-toggle="ajaxtab" data-target="#files" data-reload="false">附件</a></li>
			        <c:if test="${user.userIdentity==1}">
			        <li><a href="<%=request.getContextPath()%>/memberoperator/advisor-rz/to-advisor-admin-info.do?userId=${user.id}" 
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="feed" ></div>
                </div>
        </div>
        <div style="margin:10px auto 0; width:100%;">
	       	<label>审核意见</label>
	       	<textarea rows="5" cols="50" id="auditRemark" maxlength="100"></textarea>
	    </div>
</div>
...
<div class="bjui-pageFooter">
 	<ul>
        ...
        <li><a id="back" class="btn btn-orange">审核不通过</a></li>
