		 ...
		 <table class="table table-condensed table-hover">
                <tbody>
                    ...
                    <tr id="companyOrgCodeTR">
                        <td colspan="2">
                            <label class="control-label x140">组织机构代码：</label>
                            <c:choose>
                            <c:when test="${user == null }">
                            <input data-toggle="lookup" data-title="机构选择" data-url="<%=request.getContextPath()%>/user/companySearch.do" data-width="600" data-height="400" type="text" name="companyOrgCode" value="${user.companyOrgCode }" id="companyOrgCode" size="20" data-rule="required;jgcode" data-ok="" data-rule-jgcode="[/^(\S{10}|\S{18})$/, '代码不正确']">
                            </c:when>
                            <c:otherwise>
                    ...
                    <tr id="parentCompanyOrgCodeTR" class="hide">
                        <td colspan="2">
                            <label class="control-label x140">所属法人组织机构代码：</label>
                            <c:choose>
                            <c:when test="${user == null }">
                            <input type="text" name="parentCompanyOrgCode" id="parentCompanyOrgCode" size="20" data-rule="required;jgcode" data-rule-jgcode="[/^(\S{10}|\S{18})$/, '代码不正确']" data-ok="" disabled>
                            </c:when>
                            <c:otherwise>
