                    ...
                    <c:if test="${user.orgTypeId==3 }">
                   	<tr>
                		<td colspan="2">
                            ...
                            <input type="text" name="parentCompanyOrgCode" value="${userPub.companyOrgCode }" id="parentCompanyOrgCode" size="20" data-rule="required;jgcode;validParentCompanyCode;" data-rule-jgcode="[/^(\S{10}|\S{18})$/, '代码不正确']" data-rule-validParentCompanyCode="validParentCompanyCode"> <span class="">亦可输入社会信用代码</span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
