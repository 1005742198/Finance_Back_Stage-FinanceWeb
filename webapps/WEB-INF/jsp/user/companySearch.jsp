...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/user/companySearch.do">
        <div class="bjui-searchBar">
            ...
            <label>组织机构代码(社会信用代码)：</label><input type="text" value="<c:out value='${search.companyOrgCode}'/>" name="companyOrgCode" size="10" class="form-control"/>&nbsp;
...
<div class="bjui-pageContent">
    <table data-toggle="tablefixed" data-width="100%">
        <thead>
            <tr>
            	<th width="20%" align="center">组织机构代码<br/>(社会信用代码)</th>
