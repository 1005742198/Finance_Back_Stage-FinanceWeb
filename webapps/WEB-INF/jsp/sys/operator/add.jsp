...
<script type="text/javascript">
		...
		function validLoginName(element){
			return $.post( "${ctx}/memberoperator/validloginname.do",
...
<div class="bjui-pageContent">
	<form id="mainForm" action="${ctx}/memberoperator/save.do" data-toggle="validate" data-confirm-msg="确定要提交嘛？" data-callback="formcallback">
