...
<div class="bjui-pageContent">
	<form id="msgadd" action="<%=request.getContextPath()%>/syssmschannel/add.do" data-toggle="validate" data-reload-navtab="true" data-callback="addMsgCallback">
		 	...
		 	<tbody>
				<tr>
					<td >
						...
						<input type="text" name="channelName" maxlength="200"  data-msg-range="请输入通道名称" value="<c:out value='${obj.channelName}'/>" size="20"><span style="color:red">&nbsp;&nbsp;*</span>
					</td>
				</tr>
				<tr>
					<td>
						<label class="control-label x110">优先级：</label>  <!--  -->
						<input type="text" name="priority" value="<c:out value='${obj.priority}'/>"  data-msg-range="请输入小于10000的整数" size="20"><span style="color:red">&nbsp;&nbsp;*</span>
						&nbsp;&nbsp;规则说明：数字越小优先级越高
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						...
						<input value="1" <c:if test="${obj.useEnabled==1}">checked</c:if> type="checkbox" name="useEnabled" id="useEnabled" checked data-toggle="icheck">
					</td>
				</tr>
				<tr>
					<td align="center">
