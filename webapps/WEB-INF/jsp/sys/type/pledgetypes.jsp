...
<div class="bjui-pageContent tableContent">
    <form action="" id="j_custom_form" class="pageForm" data-toggle="validate" method="post">
        <table id="tabledit1" data-reload-navtab="true" class="table table-bordered table-hover table-striped table-top"  data-toggle="tabledit" data-initnum="0" data-action="<%=request.getContextPath()%>/systypememberpledge/edit.do" data-single-noindex="true" data-callback="afterEdit">
            <thead>
                <tr data-idname="customList[#index#].id">
                    <th title="质押物编码"  data-noedit="true"><input type="text" name="systypeMemberPledge[#index#].id" size="2" readonly></th>
                    <th title="质押物类型名称"><input type="text" name="systypeMemberPledge[#index#].pledgeTypeName" data-rule="required" size="5"></th>
