...
<div class="bjui-pageContent">
		 <table class="table table-condensed table-hover" width="100%">
		 	...
		 	<tbody>
				<tr>
					<td colspan="2">
						<label class="control-label x110">产品代码：</label> 
						<span>${obj.projectCode}</span>
					</td>
				</tr>
				<tr>
					<td>
						<label class="control-label x110">产品全称：</label> 
						<span>${obj.projectFullName}</span>
					</td>
					<td>
						<label class="control-label x110">产品简称：</label> 
						<span>${obj.projectName}</span>
					</td>
				</tr>
				<tr>
					<td>
						<label class="control-label x110">拟发行规模：</label> 
						<span><fmt:formatNumber value="${obj.projectMoney}"/>元</span>
					</td>
					<td>
						<label class="control-label x110">发行规模下限：</label> 
						<span><fmt:formatNumber value="${obj.projectAmountMin*obj.projectUnitPrice}"/>元</span>
					</td>
				</tr>
				<tr>
					<td>
						<label class="control-label x110">产品期限：</label> 
				...
				<tr>
					<td>
						<label class="control-label x110">产品起息日：</label> 
						<span><fmt:formatDate value="${obj.valueDate}" pattern="yyyy-MM-dd"/></span>
					</td>
					<td>
						<label class="control-label x110">产品到期日：</label> 
