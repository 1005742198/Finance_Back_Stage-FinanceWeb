...
<div class="bjui-pageContent">
        <div style="margin:0px auto 0; width:100%;">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li ><a href="<%=request.getContextPath()%>/incomeright/profiles/view.do?projectId=${obj.id}&infoType=1&belongType=1" 
                    	role="tab" data-toggle="ajaxtab" data-target="#bankinfo" data-reload="false">见证信息</a></li>
                    <li><a href="<%=request.getContextPath()%>/incomeright/profiles/view.do?projectId=${obj.id}&infoType=2&belongType=1" 
                    	role="tab" data-toggle="ajaxtab" data-target="#pledge" data-reload="false">质押信息</a></li>
                    <li><a href="<%=request.getContextPath()%>/incomeright/profiles/view.do?projectId=${obj.id}&infoType=3&belongType=1" 
                    	role="tab" data-toggle="ajaxtab" data-target="#otherfiles" data-reload="false">其他附件</a></li>
            	<li><a href="<%=request.getContextPath()%>/incomeright/proinfo/feedlist.do?projectId=${obj.id}&belongType=1" 
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="baseinfo">
                    	<%@ include file="/WEB-INF/jsp/pro/incomeright/recordinfo/proinfo-base.jsp" %>
                    </div>
