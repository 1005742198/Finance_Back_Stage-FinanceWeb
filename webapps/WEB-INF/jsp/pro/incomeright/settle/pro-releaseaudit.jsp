...
<div class="bjui-pageContent" id="pro-doreleasemoney">
	<form id="mainForm" action="<%=request.getContextPath()%>/incomeright/settle/releaseaudit.do" data-reload-navtab="true" data-confirm-msg="确定审核通过？" data-toggle="validate" data-callback="afterSubmit">
...
function resend() {
	$.ajax({
		type : "post",
		url : "<%=request.getContextPath()%>/incomeright/settle/sendReleaseCaptcha.do",
		data : {k:$("#k").val()},
		dataType : "json",
		timeout : 5000,
		cache : false,
