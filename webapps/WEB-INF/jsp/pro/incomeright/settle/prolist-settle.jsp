...
<div class="bjui-pageHeader" id="prolist-issue-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/incomeright/settle/prolist.do" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<c:forEach var="obj" items="${list}">
	    	<tr>
	    		...
	    		<td>
	    		<c:if test="${(obj.isNotReleaseMoney() || obj.isNotRefund()) && powerlist.contains('/incomeright/settle/settleindex.do') }">
	    				<a href="<%=request.getContextPath()%>/incomeright/settle/settleindex.do?projectId=${obj.id}" 
	    		...
	    		<!-- 
	    			<c:if test="${obj.isCfmrightinfo() }">
	   				 ...
	   				 -->
	    			<a href="<%=request.getContextPath()%>/incomeright/settle/settledetail.do?projectId=${obj.id}" 
