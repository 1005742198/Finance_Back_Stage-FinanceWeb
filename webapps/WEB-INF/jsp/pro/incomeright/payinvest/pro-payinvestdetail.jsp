...
<div class="bjui-pageHeader" id="pro-payinvestdetail-search">
    ...
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/incomeright/proclaims/payinvest/payindex.do?index=2&repayPlanId=${obj.id}" method="post">
