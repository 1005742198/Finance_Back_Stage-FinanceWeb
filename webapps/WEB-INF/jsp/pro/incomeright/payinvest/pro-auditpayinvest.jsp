...
<div class="bjui-pageContent">
	<form id="formSubmit" action="<%=request.getContextPath()%>/incomeright/proclaims/payinvest/audit.do" data-toggle="validate" data-confirm-msg="确定要提交嘛？"  data-callback="callback">
		 ...
		 <table class="table table-condensed table-hover" width="100%">
				...
				<tr align="left">
					<td colspan="2">
						...
						<a href="<%=request.getContextPath()%>/incomeright/proclaims/payinvest/applyhistory.do?relationId=${obj.id}" data-toggle="dialog" data-width="800"  
...
function resend() {
	$.ajax({
		type : "post",
		url : "<%=request.getContextPath()%>/incomeright/proclaims/payinvest/sendPayInvestCaptcha.do",
		data : {k:$("#k").val()},
		dataType : "json",
		timeout : 5000,
		cache : false,
