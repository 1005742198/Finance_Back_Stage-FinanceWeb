...
<div class="bjui-pageContent"  id="pro-review">
	<form id="form" action="<%=request.getContextPath()%>/incomeright/review/${action}.do" data-reload-navtab="true" data-toggle="validate" data-confirm-msg="确定审核通过？" data-callback="projectupateCallback">
		 ...
		 <table class="table-condensed" width="100%">
				...
				<tr>
					<td>
						...
						<input <c:if test="${project.manageDuration==1}">checked</c:if> <c:if test="${project.tradeType==2 }">disabled</c:if> name="manageDuration" id="manageDuration1" type="radio" value="1" data-toggle="icheck" data-label="是" data-rule="checked">
						<input <c:if test="${project.manageDuration==0}">checked</c:if> name="manageDuration" id="manageDuration0" type="radio" value="0" data-toggle="icheck" data-label="否" data-rule="checked">
					</td>
				</tr>
				<tr>
					<td>
