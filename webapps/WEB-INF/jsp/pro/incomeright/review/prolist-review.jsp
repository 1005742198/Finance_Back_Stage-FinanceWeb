...
<div class="bjui-pageHeader" id="prolist-review-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/incomeright/review/${action}.do" method="post">
        <input type="hidden" name="pageSize" value="${pageSize}">
        <div class="bjui-searchBar">
            <%@ include file="search_itembase.jsp" %>
            <label>提交时间：</label>
...
<div class="bjui-pageContent" id="prolist-review-list">
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tr>
    		...
    		<th align="center" width="15%">发行人</th>
    		<th align="center" width="8%">挂牌代码</th>
    		<th align="center" width="15%">挂牌产品简称</th>
    		<th align="center" width="12%">挂牌规模</th>
    		<th align="center" width="8%">产品期限</th>
    		<th align="center" width="10%">预期年化收益率</th>
    		<th align="center" width="10%">还款方式</th>
    	...
    	<tr>
    		...
    		<td>
    		<a href="<%=request.getContextPath()%>/incomeright/proinfo/view.do?id=${obj.id}" 
    				data-toggle="dialog" data-width="1000"  data-height="600" data-id="dialog-mask" 
    				data-mask="true" >${obj.projectName}</a>
    		</td>
    		...
    		<td>
    			<c:if test="${powerlist.contains('/incomeright/review/view.do')}">
    			<a href="<%=request.getContextPath()%>/incomeright/review/view.do?id=${obj.id}" 
	   				class="btn btn-blue" data-toggle="dialog" data-width="800"  
	   				data-height="450" data-id="dialog-mask" data-mask="true">审核</a>
	   			</c:if>
    			<a href="<%=request.getContextPath()%>/incomeright/proinfo/feedlist.do?projectId=${obj.id}&belongType=2" 
