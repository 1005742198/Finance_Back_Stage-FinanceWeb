...
<div class="bjui-pageHeader" id="prolist-review-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/incomeright/recordreview/${action}.do" method="post">
...
<div class="bjui-pageContent" id="prolist-review-list">
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tr>
    		...
    		<td><a href="<%=request.getContextPath()%>/incomeright/recordinfo/view.do?id=${obj.id}" 
    		...
    		<td>
    			<c:if test="${powerlist.contains('/incomeright/recordreview/view.do')}">
    			<a href="<%=request.getContextPath()%>/incomeright/recordreview/view.do?id=${obj.id}" 
	   				class="btn btn-blue" data-toggle="dialog" data-width="800"  
	   				data-height="400" data-id="dialog-mask" data-mask="true">审核</a>
	   			</c:if>
    			<a href="<%=request.getContextPath()%>/incomeright/proinfo/feedlist.do?projectId=${obj.id}&belongType=1" 
