...
<div class="bjui-pageHeader" id="prolist-repay-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/incomeright/proclaims/repay/recentlylist.do" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<c:forEach var="list" items="${list}">
    		<tr>
    			...
    			<a href="<%=request.getContextPath()%>/incomeright/proclaims/repay/repaylist.do?projectId=${list.projectId}&periodNumber=${list.periodNumber}" 
    				data-toggle="dialog" data-width="1000"  
