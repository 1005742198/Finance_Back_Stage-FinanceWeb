...
<div class="bjui-pageHeader" id="prolist-repay-query-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/incomeright/proclaims/repay/list.do" method="post">
        ...
        <div class="bjui-moreSearch">
			<%@ include file="/WEB-INF/jsp/pro/incomeright/repay/search_itemext.jsp" %>
        </div>
    </form>
</div>
