...
<div class="bjui-pageHeader" id="prolist-payinvest-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/debt/proclaims/payinvest/overlist.do" method="post">
...
<div class="bjui-pageContent"  id="prolist-payinvest">
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tr>
    		...
    		<td><c:forEach var="item" items="${payInvestStatusDesc}"><c:if test="${item.value==list.payInvestStatus}">${item}</c:if></c:forEach>(<span class="red">逾期</span>)</td>
    		<td>
