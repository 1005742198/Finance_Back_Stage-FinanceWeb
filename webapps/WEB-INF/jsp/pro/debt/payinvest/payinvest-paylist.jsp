...
<div class="bjui-pageHeader" id="pro-drawbacklist-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/debt/proclaims/payinvest/paylist.do?projectId=${search.projectId}" method="post">
...
<div class="bjui-pageContent tableContent" id="pro-drawbacklist-list">
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tr>
    		...
    		<td><fmt:formatDate value="${list.payResultTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
