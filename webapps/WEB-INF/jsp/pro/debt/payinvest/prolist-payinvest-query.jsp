...
<div class="bjui-pageHeader" id="prolist-payinvest-query-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/debt/proclaims/payinvest/list.do" method="post">
        ...
        <div class="bjui-moreSearch">
			<%@ include file="/WEB-INF/jsp/pro/debt/payinvest/search_itemext.jsp" %>
        </div>
    </form>
</div>
...
<div class="bjui-pageContent"  id="prolist-payinvest-query-list">
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tr>
    		...
    		<td><c:forEach var="item" items="${payInvestStatusDesc}"><c:if test="${item.value==list.payInvestStatus}">${item}</c:if></c:forEach></td>
    		<td>
    			...
    			<a href="<%=request.getContextPath()%>/debt/proclaims/payinvest/applyhistory.do?relationId=${list.id}" 
    				data-toggle="dialog" data-width="1000"  
