...
<div class="bjui-pageContent">
	<form id="formSubmit" action="<%=request.getContextPath()%>/debt/proclaims/payinvest/dopay.do" data-toggle="validate" data-confirm-msg="确定要提交嘛？"  data-callback="callback">
