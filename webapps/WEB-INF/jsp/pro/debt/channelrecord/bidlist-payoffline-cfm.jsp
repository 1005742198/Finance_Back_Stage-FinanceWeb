...
<table class="table table-condensed table-hover" width="100%">
        <tbody>
            <tr>
                ...
                <td>
                    <label class="control-label x120">申购时间：</label>
                    <span><fmt:formatDate value="${orderApply.createTime}"/></span>
                </td>
                <td>
                    <label class="control-label x120">申购金额：</label>
...
<input type="hidden" name="applyId" id="applyId" value="${orderApply.id}">
...
function updateOffline(obj){
	...
	$.ajax({
		   type: "POST",
		   async: false,
		   url: "<%=request.getContextPath()%>/debt/proissue/settle/payoffline_pay.do",
