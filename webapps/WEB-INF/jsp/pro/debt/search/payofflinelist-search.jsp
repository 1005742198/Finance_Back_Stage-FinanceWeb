 ...
 <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tbody>
    		...
    		<tr>
	    		...
	    		<c:when test="${obj.productTypeId==3 }">
	    		<c:if test="${powerlist.contains('/incomeright/prosearch/payoffline-cfm-info.do')}">
	    			<a href="<%=request.getContextPath()%>/incomeright/prosearch/payoffline-cfm-info.do?orderApplyId=${obj.id}&applyOrderType=${obj.applyOrderType}" 
	    				data-toggle="dialog" data-width="1300"  
	    				data-height="500" data-id="dialog-mask" data-mask="true">到款确认明细</a>
	    		</c:if>
	    		</c:when>
	    		<c:otherwise>
	    		<c:if test="${powerlist.contains('/debt/prosearch/payoffline-cfm-info.do')}">
	    		<a href="<%=request.getContextPath()%>/debt/prosearch/payoffline-cfm-info.do?orderApplyId=${obj.id}&applyOrderType=${obj.applyOrderType}" 
	    				data-toggle="dialog" data-width="1300"  
	    				data-height="500" data-id="dialog-mask" data-mask="true">到款确认明细</a>
	    		</c:if>
	    		</c:otherwise>
