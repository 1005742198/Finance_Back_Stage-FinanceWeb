...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/debt/orderapply/list.do" method="post">
...
<div class="bjui-pageContent"  id="pro-applylist-list">
    <table data-toggle="tablefixed" data-width="100%" data-height="100%">
    	<thead>
    	<tr>
    		<th align="center" width="11%">投资者</th>
    		<th align="center" width="6%">项目期数</th>
    		<th align="center" width="14%">认购时间</th>
    		<th align="center" width="11%">认购金额(元)</th>
    		<th align="center" width="11%">到账金额(元)</th>
    		<th align="center" width="6%">到账状态</th>
    		<th align="center" width="14%">到账时间</th>
    		<th align="center" width="6%">支付方式</th>
    		<th align="center" width="11%">确认金额(元)</th>
    		<th align="center" width="11%">退款金额(元)</th>
    	</tr>
    	</thead>
    	<tbody>
