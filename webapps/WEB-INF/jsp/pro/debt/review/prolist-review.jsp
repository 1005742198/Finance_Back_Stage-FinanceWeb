...
<div class="bjui-pageHeader" id="prolist-review-search">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/debt/proissue/review/${action}.do" method="post">
...
<div class="bjui-pageContent" id="prolist-review-list">
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tr>
    		...
    		<th align="center" width="15%">挂牌项目简称</th>
    		<th align="center" width="12%">挂牌规模</th>
    		<th align="center" width="8%">项目期限</th>
    	...
    	<tr>
    		...
    		<td><a href="<%=request.getContextPath()%>/debt/proissue/proinfo/view.do?id=${obj.id}" 
    		...
    		<td>
    			<c:if test="${powerlist.contains('/debt/proissue/review/view.do')}">
    			<a href="<%=request.getContextPath()%>/debt/proissue/review/view.do?id=${obj.id}" 
	   				class="btn btn-blue" data-toggle="dialog" data-width="800"  
	   				data-height="450" data-id="dialog-mask" data-mask="true">审核</a>
	   			</c:if>
    			<a href="<%=request.getContextPath()%>/debt/proissue/proinfo/feedlist.do?projectId=${obj.id}&belongType=2" 
