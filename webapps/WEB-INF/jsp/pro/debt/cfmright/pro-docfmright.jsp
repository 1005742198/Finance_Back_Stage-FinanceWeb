...
<div class="bjui-pageContent">
	<form id="byUnderwriterform" action="<%=request.getContextPath()%>/debt/proissue/cfmright/docfmright.do" data-toggle="validate" data-confirm-msg="确定要提交嘛？" data-callback="afterCfmRight">
		 	...
		 	<tbody>
				...
				<tr>
					...
					<td>
						...
						<span><fmt:formatNumber value="${cfmRight.projectMoney}" pattern="0.00"/> 元</span>
					</td>
					<td>
