...
<div class="bjui-pageContent">
	<form id="refreshuploadtradefile" action="<%=request.getContextPath()%>/debt/proissue/cfmright/refreshuploadtradefile.do" enctype="multipart/form-data" method="post" data-toggle="validate" data-reload-navtab="true" data-confirm-msg="确定要保存吗？" data-callback="addtradefilecallback">
