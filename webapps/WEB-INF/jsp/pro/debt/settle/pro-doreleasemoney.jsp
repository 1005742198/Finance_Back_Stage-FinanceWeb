...
<div class="bjui-pageContent" id="pro-doreleasemoney">
	<form id="mainForm" action="<%=request.getContextPath()%>/debt/proissue/settle/releasemoney.do" data-toggle="validate" data-confirm-msg="确定要放款？" data-callback="afterSubmit">
