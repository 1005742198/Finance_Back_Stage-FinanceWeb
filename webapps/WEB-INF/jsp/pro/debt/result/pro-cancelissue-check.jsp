...
<div class="bjui-pageContent" id="pro-cancelissue">
	<form id="cancleform" action="<%=request.getContextPath()%>/debt/proissue/result/do-pro-cancelissue.do" data-toggle="validate" data-confirm-msg="确定要提交吗？" data-callback="afterCancle">
...
<script>
	...
	function nocancelissue(){
		$("#cancleform").attr("action","<%=request.getContextPath()%>/debt/proissue/result/do-pro-nocancelissue.do");
		$("#cancleform").submit();
	}
</script>
