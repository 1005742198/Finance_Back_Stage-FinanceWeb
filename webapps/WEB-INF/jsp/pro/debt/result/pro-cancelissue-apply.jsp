...
<div class="bjui-pageContent" id="pro-cancelissue">
	<form action="<%=request.getContextPath()%>/debt/proissue/result/pro-cancelissue-apply.do" data-toggle="validate" data-confirm-msg="确定要申请吗？" data-callback="afterApply">
