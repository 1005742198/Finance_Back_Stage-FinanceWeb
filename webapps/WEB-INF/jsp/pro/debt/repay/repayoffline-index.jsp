...
<div class="bjui-pageContent">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <!-- 
                   <li><a href="<%=request.getContextPath()%>/debt/proclaims/repay/payrepay-list.do?repayId=${obj.id}" 
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="payoffline">
                    	<%@ include file="/WEB-INF/jsp/pro/debt/repay/repayoffline-cfm.jsp" %>
                    </div>
                     <!-- 
                    <div class="tab-pane fade bjui-layout" id="paylist" data-toggle="autoajaxload"
                    	data-url="<%=request.getContextPath()%>/debt/proclaims/repay/payrepay-list.do?repayId=${obj.id}"></div>
                    	 -->
                </div>
</div>
