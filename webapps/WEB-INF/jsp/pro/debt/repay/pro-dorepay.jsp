...
<div class="bjui-pageContent">
	<form id="formSubmit" action="<%=request.getContextPath()%>/debt/proclaims/repay/repay.do" data-toggle="validate" data-confirm-msg="确定要提交嘛？"  data-callback="callback">
		...
		<input type="hidden" name="versionNo" value="${obj.versionNo}">
		 <table class="table table-condensed table-hover" width="100%">
				...
				<tr align="left">
					<td colspan="2">
						<label class="control-label x110">项目编号：</label> 
