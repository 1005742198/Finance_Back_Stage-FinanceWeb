...
<div class="bjui-pageContent">
        <div style="margin:0px auto 0; width:100%;">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li><a href="<%=request.getContextPath()%>/debt/proissue/profiles/view.do?projectId=${obj.id}&infoType=3&belongType=2" 
                    	role="tab" data-toggle="ajaxtab" data-target="#otherfiles" data-reload="false">附件</a></li>
            	<li><a href="<%=request.getContextPath()%>/debt/proissue/proinfo/feedlist.do?projectId=${obj.id}&belongType=2" 
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="baseinfo">
                    	<%@ include file="/WEB-INF/jsp/pro/debt/info/proinfo-base.jsp" %>
                    </div>
