...
<div class="bjui-pageContent">
	<form action="#" data-toggle="validate" data-confirm-msg="确定要提交嘛？" >
		 	...
		 	<tbody>
				...
				<tr>
					<td>
						...
						<span><fmt:formatNumber value="${cfmright.cfmRightMoney}" pattern="0.00"/></span>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						...
						<span><c:forEach var="item" items="${releaseStatusDesc}"><c:if test="${item.value==cfmright.releaseStatus}">${item}</c:if></c:forEach></span>
					</td>
				</tr>
				<tr>
					<td>
