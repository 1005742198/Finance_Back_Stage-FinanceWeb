...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/bizmoney/fee/ptlist.do" method="post">
...
<div class="bjui-pageContent">
    <table data-toggle="tablefixed" data-width="100%">
    	...
    	<tr>
    		...
    		<th align="center" width="18%">确权金额</th>
    		<th align="center" width="20%">服务费信息</th>
    		<th align="center" width="22%">费用时间</th>
    		<th align="center" width="10%">划付状态</th>
    	</tr>
    	</thead>
    	<tbody>
    	...
    	<tr>
    		...
    		服务费率：<fmt:formatNumber value="${list.platformFee}" type="percent" maxFractionDigits="3" minFractionDigits="2"/></td>
