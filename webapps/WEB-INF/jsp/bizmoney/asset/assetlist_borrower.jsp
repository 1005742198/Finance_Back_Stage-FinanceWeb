...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<%=request.getContextPath()%>/bizmoney/asset/borrowerlist.do" method="post">
        ...
        <div class="bjui-searchBar">
        	...
        	<label>融资方：</label><input type="text" name="userName" value="<c:out value='${search.userName }'/>" class="form-control" size="10"/>
...
<div class="bjui-pageContent">
    <table data-toggle="tablefixed" data-width="100%">
    	<thead>
    	<tr>
    		<th align="center" width="13%">融资方信息</th>
    		<th align="center" width="16%">项目信息</th>
    		<th align="center" width="8%">资产日期</th>
    		<th align="center" width="12%">融资资金</th>
    		<th align="center" width="11%">预期利息</th>
    		<th align="center" width="12%">未还资金</th>
    		<th align="center" width="10%">已付利息</th>
    		<th align="center" width="10%">未付利息</th>
    	...
    	<tr>
    	<td><a href="<%=request.getContextPath()%>/user/view.do?id=${list.userId}" 
    				data-toggle="dialog" data-width="1000"  data-height="600" data-id="dialog-mask" 
    				data-mask="true" >${list.realName }</a>
    	</td>
